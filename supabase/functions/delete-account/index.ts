...
Deno.serve(async (req) => {
  // Browsers send an OPTIONS preflight before the real request for
  // cross-origin calls with custom headers like Authorization — it never
  // includes that header, so it must be handled separately, before any
  // auth check, or every real browser-based call fails.
